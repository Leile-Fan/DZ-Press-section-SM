        ...
        maintenance: {
          topics: {
            safety: {
              ...
              sections: [
                { title: "2.1 基本安全条例 General Safety Regulations", paragraphs: [{ cn: "安全一章包含基本安全条例，使用机器/设备或在机器/设备上作业时必须遵守该法规。手册中相关章节的每项活动都有附加安全指导，补充基本规定的内容。这些说明在文本中加上特殊的警告标志。非安德里茨有限公司制造部件的安全指导包含在由分包商提供的文件中。所有的安全指导都应当遵守。不遵守安全指导会导致人员受伤、环境破坏和/或材料损坏。运营公司必须制定全面的基本安全计划。在设备及其周围工作的人员，都应当接受操作这类设备和运行工艺的培训，包括安装围栏、设置标志的场所。", en: "The SAFETY chapter contains general safety regulations that must be observed when working with/on the machine. The regulations are supplemented by additional safety instructions for individual activities. These instructions are highlighted with special warning signs. Safety instructions on components not supplied by ANDRITZ are contained in sub-supplier documentation. All safety instructions must be observed. Non-observance can lead to personal injury, environmental damage, and/or material damage. The operating company must compile a comprehensive general safety program. Personnel must receive training for working on plants of this type." }]},
                { title: "2.2 危险和警告标志 Danger & Warning Signs", paragraphs: [{ cn: "整个《安全》章节的内容均与安全有关，因而非常重要。各个章节的警告内容都附加了象形符号、信号说明和信号颜色：🔴 DANGER 危险 — 表示直接威胁生命和肢体；⚠️ WARNING 警告 — 表示可能有威胁生命和肢体的危险情况；⚠️ CAUTION 小心 — 表示可能有危险情况，可能造成轻微人身伤害或设备/环境损坏；ℹ️ NOTICE 注意 — 表示可能造成财产损失的情况。所有设备的危险区域须设置相应的警告标志。", en: "The entire SAFETY chapter is of extreme importance. Warnings in individual chapters are marked with pictogram, signal word, and signal color: DANGER — imminent danger to life and limb; WARNING — possible danger to life and limb; CAUTION — possible danger causing minor injury or damage; NOTICE — possible property damage. All danger zones must have appropriate warning signs.", image: "images-general/page16-img05.png", imageCaption: "Fig. 1: EMERGENCY STOP switch designs / 紧急停机开关设计" }]},
                { title: "2.3 指定用途 Intended Use", paragraphs: [{ cn: "本设备专门用于生产卫生纸（卫生纸、餐巾纸、手帕纸、面巾纸）。任何超出此范围的使用均被视为违反指定用途。非指定用途包括但不限于：加工未获ANDRITZ书面批准的其他纸种或原材料、在超出设计参数（速度、温度、压力等）的条件下运行设备。运营公司对因非指定用途造成的任何损害承担全部责任。", en: "The machine is exclusively intended for tissue paper production (toilet paper, napkins, handkerchiefs, facial tissues). Any use beyond this is considered improper. Improper use includes processing other paper grades or raw materials not approved in writing by ANDRITZ, and operating beyond design parameters (speed, temperature, pressure). The operating company bears full liability for damages from improper use." }]},
                { title: "2.4 设备安全基本说明 General Machine Safety", paragraphs: [{ cn: "设备按照最新技术标准设计制造，在正确使用和维护下可安全运行。然而设备运行中仍存在残余风险，特别是：旋转部件（辊子、网、毯）可能造成卷入危险；高温表面（扬克缸、蒸汽管道）可能造成烫伤；高压流体（蒸汽、液压、气动）可能造成喷射伤害；化学品（清洁剂、涂料）可能造成皮肤和呼吸道伤害；噪音可能造成听力损伤。操作人员必须了解这些残余风险并采取相应防护措施。", en: "The machine is designed and manufactured according to the latest technical standards and can be operated safely with proper use and maintenance. However, residual risks exist: rotating parts (rolls, wire, felt) pose entanglement hazards; hot surfaces (Yankee, steam pipes) pose burn hazards; pressurized fluids (steam, hydraulic, pneumatic) pose injection hazards; chemicals (cleaning agents, coatings) pose skin and respiratory hazards; noise may cause hearing damage. Operators must be aware of these residual risks and take appropriate protective measures." }]},
                { title: "2.5 危险应用情况 Hazardous Applications", paragraphs: [{ cn: "在以下情况下设备特别危险：安全装置被拆除或绕过时；维护工作期间设备未正确锁定/挂牌时；处理化学品（清洁剂、涂料）时未佩戴防护装备时；在狭窄空间内作业时；焊接作业未获批准时。以上情况必须采取额外的安全预防措施。", en: "The machine is particularly hazardous when: safety devices are removed or bypassed; machine is not properly locked/tagged during maintenance; chemicals are handled without PPE; work is performed in confined spaces; welding is performed without approval. Additional safety precautions must be taken in these situations." }]},
                { title: "2.6 运营公司责任 Operator Obligations", paragraphs: [{ cn: "运营公司必须确保：设备仅在安全、功能正常的状态下运行；所有安全装置和防护罩在位且功能正常；为所有操作和维护人员提供足够的个人防护装备（PPE）；制定书面的操作和安全程序，并对人员进行培训；提供充足的照明（维修时使用超低压灯泡）；确保维护作业空间充足；不超过起重机/吊具的允许载荷；固定载荷防止高处坠落。", en: "The operating company must ensure: machine runs only in safe, functional condition; all safety devices and guards are in place and functional; adequate PPE is provided to all operators and maintenance personnel; written operating and safety procedures are established and personnel trained; adequate lighting is provided (extra-low voltage for maintenance); adequate maintenance space is ensured; crane/lifting gear capacities are not exceeded; loads are secured against falling." }]},
                { title: "2.7 人员基本责任 Personnel Obligations", paragraphs: [{ cn: "所有在设备上或设备周围作业的人员必须：阅读并理解操作手册（特别是安全章节）；遵守所有安全条例和警告标志；在开始工作前检查安全装置是否功能正常；发现安全隐患或设备损坏时立即向主管报告；不得拆除、绕过或使安全装置失效；作业时穿戴规定的个人防护装备。未经授权人员不得进入设备区域。维修和保养工作只能由经过专门培训的熟练人员执行。电气设备的所有作业毫无例外必须由熟练电工进行。", en: "All personnel working on or near the machine must: read and understand the manual (especially the SAFETY chapter); follow all safety regulations and warning signs; check safety devices before starting work; immediately report safety hazards or equipment damage to the supervisor; never remove, bypass, or disable safety devices; wear prescribed PPE. Unauthorized personnel must not enter the machine area. Maintenance and service work may only be performed by specially trained, skilled personnel. All electrical work must be carried out by skilled electricians." }]},
                { title: "2.8 安全装置 Safety Devices", paragraphs: [{ cn: "设备配备以下安全装置：紧急停机（E-STOP）按钮/拉线开关 — 分布在设备的关键位置，触发后立即停止所有驱动；防护罩和护栏 — 防止接触旋转部件和高温表面；联锁装置 — 防止在危险条件下启动设备；警示灯和警报器 — 指示设备运行状态和故障。安全装置不得被拆除、绕过或使其失效。每次维修后必须重新安装并测试所有安全装置。紧急停机开关必须定期（每月）进行功能测试。", en: "The machine is equipped with: EMERGENCY STOP buttons/pull-cords at key locations — immediately stop all drives when activated; guards and railings — prevent contact with rotating parts and hot surfaces; interlocks — prevent startup under hazardous conditions; warning lights and alarms — indicate operating status and faults. Safety devices must never be removed, bypassed, or disabled. All safety devices must be reinstalled and tested after each maintenance. EMERGENCY STOP switches must be functionally tested regularly (monthly).", image: "images-general/page16-img05.png", imageCaption: "Fig. 1: EMERGENCY STOP switch / 紧急停机开关" }]},
                { title: "2.9 个人防护装备 Personal Protective Apparel", paragraphs: [{ cn: "在设备区域作业时必须穿戴以下个人防护装备：安全帽 — 防止头部受伤；防护手套 — 处理化学品或更换刮刀片时佩戴防割/防化手套；安全鞋（带钢头）— 防止重物砸伤；护目镜/面罩 — 防止飞溅物和化学品伤害；听力保护装置 — 噪音水平超过85 dB(A)时必须佩戴；防护服 — 防止化学品和高温伤害。个人防护装备由运营公司提供并定期检查更换。", en: "The following PPE must be worn when working in the machine area: safety helmet; protective gloves (cut/chemical resistant when handling chemicals or changing doctor blades); safety shoes (steel-toe); goggles/face shield; hearing protection (mandatory when noise >85 dB(A)); protective clothing. PPE is provided by the operating company and must be regularly inspected and replaced." }]},
                { title: "2.10 设备安装现场安全 Site Safety", paragraphs: [{ cn: "设备安装现场必须：保持通道和走台畅通无障碍；地面不得有油污、水渍或化学品泄漏；排水沟在不使用时须覆盖；提供足够的灭火器材；紧急出口保持畅通并设有明确标识。走台和通道的栏杆必须完好，承重能力足够。", en: "The installation site must: keep walkways and platforms clear and unobstructed; keep floor free of oil, water, or chemical spills; cover drainage channels when not in use; provide adequate fire extinguishers; keep emergency exits clear and clearly marked. Walkway railings must be intact with adequate load capacity." }]},
                { title: "2.11 温度 Temperature", paragraphs: [{ cn: "设备运行中会产生高温表面，特别是扬克缸（表面温度可达120°C以上）、蒸汽管道和相关阀门。高温表面即使停机后仍可能保持高温较长时间。接触高温表面会导致严重烫伤。在高温区域作业时必须穿戴隔热手套和防护服。高温管道应进行隔热处理。", en: "The machine generates hot surfaces during operation, particularly the Yankee cylinder (surface can exceed 120°C), steam pipes, and associated valves. Hot surfaces may remain hot long after shutdown. Contact with hot surfaces causes severe burns. Heat-resistant gloves and protective clothing must be worn when working in hot areas. Hot pipes should be insulated." }]},
                { title: "2.12 噪音 Noise", paragraphs: [{ cn: "设备运行噪音水平可能超过85 dB(A)，特别是在：流浆箱区域、真空系统、扬克缸驱动、卷纸机区域。噪音超过85 dB(A)时必须佩戴听力保护装置。运营公司应定期测量噪音水平并记录。在噪音区域入口处设置明显的听力保护标志。", en: "Machine noise levels may exceed 85 dB(A), particularly at: headbox area, vacuum system, Yankee drive, reel area. Hearing protection must be worn when noise exceeds 85 dB(A). The operating company should regularly measure and record noise levels. Post clear hearing protection signs at noisy area entrances." }]},
                { title: "2.13 电气设备 Electrical Equipment", paragraphs: [{ cn: "电气设备的所有作业毫无例外必须由熟练电工进行。作业前必须：断开所有电源（使用维护开关或MCC可锁定支架）；验电确认无电压；接地和短路；覆盖或隔离邻近带电部件。电气柜和控制面板必须保持关闭，仅授权人员可打开。电气设备必须定期检查和测试。", en: "All electrical work must be carried out by skilled electricians without exception. Before work: disconnect all power supplies (using maintenance switch or lockable MCC racks); verify absence of voltage; ground and short-circuit; cover or isolate adjacent live parts. Electrical cabinets and control panels must remain closed, accessible only to authorized personnel. Electrical equipment must be regularly inspected and tested." }]},
                { title: "2.14 液压与气动设备 Hydraulic & Pneumatic", paragraphs: [{ cn: "液压和气动系统在维修前必须完全释放压力。高压流体喷射可导致严重的人身伤害。液压系统含有高压油——泄漏的油液可能造成滑倒危险和环境污染。气动系统中即使压力已释放，仍可能有残余压力——操作气缸和阀门时须谨慎。", en: "Hydraulic and pneumatic systems must be completely depressurized before maintenance. High-pressure fluid injection can cause severe personal injury. Hydraulic systems contain high-pressure oil — leaks pose slip hazards and environmental contamination. Pneumatic systems may retain residual pressure after depressurization — exercise caution when working on cylinders and valves." }]},
                { title: "2.15 焊接作业 Welding Work", paragraphs: [{ cn: "焊接作业通常只有在咨询ANDRITZ后才能批准。焊接作业必须遵守相关安全条例：清除焊接区域的可燃物；提供足够的通风；配备灭火器材；焊后检查是否有残留火源。焊接电流不得通过轴承或其它精密部件，否则可能导致损坏。", en: "Welding work is generally only permitted after consulting ANDRITZ. Observe relevant safety regulations: remove combustibles from welding area; provide adequate ventilation; have fire extinguishers ready; check for residual fire sources after welding. Welding current must not pass through bearings or other precision components as this may cause damage." }]},
                { title: "2.16 流体 Fluids (Liquids, Gases, Vapor, Smoke)", paragraphs: [{ cn: "设备使用的流体和化学品可能对健康有害。操作和维护时可能接触：浆料悬浮液（含纤维和化学添加剂）、清洁剂（盐酸、苛性钠、硫酸）、涂料/涂层化学品、润滑油脂、蒸汽和冷凝水。必须遵守化学品供应商的安全数据表（SDS）。", en: "Fluids and chemicals used in the machine may be hazardous to health. During operation and maintenance, exposure may occur to: pulp suspension (with fibers and chemical additives), cleaning agents (HCl, NaOH, sulfamic acid), coating chemicals, lubricating oils/greases, steam and condensate. Chemical supplier Safety Data Sheets (SDS) must be followed." }]},
                { title: "2.17 油与油脂 Oils and Greases", paragraphs: [{ cn: "润滑油和润滑脂必须妥善储存和处理。泄漏的油液应立即收集，不得排放到环境中。废油和含油抹布必须按当地法规作为危险废物处置。基于植物原材料的润滑油应分开收集和处置。定期检查所有润滑点和管路是否有泄漏。", en: "Lubricating oils and greases must be properly stored and handled. Leaked oil must be immediately collected and not discharged into the environment. Waste oil and oily rags must be disposed of as hazardous waste per local regulations. Plant-based oils should be collected and disposed of separately. Regularly check all lubrication points and lines for leaks." }]}
              ]
            },
            installation: {
              icon: "📦", title: "安装 Installation (第4章)", subtitle: "运输 · 保管 · 安装 · 冷测试 · 启动",
              sections: [
                { title: "4.3 运输 Transport", paragraphs: [{ cn: "设备部件运输时必须使用合适的吊具和绳索。辊子吊装时注意使用专用吊点（通常在轴颈或轴承座处有标记）。运输过程中防止部件碰撞和受潮。不得超过起重机和吊具的允许载荷。运输大型部件（如扬克缸）时需要专门的运输方案和路线规划。", en: "Components must be transported using appropriate lifting gear and ropes. Use dedicated lifting points for rolls (typically marked at journals or bearing housings). Prevent impact and moisture during transport. Do not exceed crane and lifting gear capacities. Large components (e.g., Yankee) require specialized transport planning and routing." }]},
                { title: "4.3.1 吊装辊子 Lifting Rolls", alerts: [{ type: "warning", title: "⚠️ 注意", content: "使用正确的吊具。吊装前检查绳索和吊具是否完好。辊子表面（特别是包胶辊）在吊装时需加以保护，防止损伤。吊装时人员不得站在悬吊负荷下方。" }], paragraphs: [{ cn: "辊子吊装时须使用专用吊点。包胶辊和施胶辊吊装时须采取保护措施防止表面损伤。大型辊子（如成形辊、真空压榨辊）由于重量大需要多人配合。", en: "Use dedicated lifting points for roll lifting. Protect covered/gummed roll surfaces during lifting. Large rolls (forming roll, suction press roll) require multi-person coordination due to weight." }]},
                { title: "4.4 保管 Safekeeping", paragraphs: [{ cn: "设备部件在安装前需要妥善保管：存放区域须干燥、通风、防雨；精密加工表面须涂抹防锈油；电子/电气部件须防潮防尘。", en: "Components require proper storage before installation: area must be dry, ventilated, rain-proof; precision machined surfaces must be coated with rust preventive; electronic/electrical parts must be protected from moisture and dust." }]},
                { title: "4.4.1 施胶辊保管 Rubberised Rolls", alerts: [{ type: "warning", title: "⚠️ 重要", content: "施胶辊的保管要求特别严格！" }], paragraphs: [{ cn: "施胶辊（橡胶包胶辊）的保管要求：避光保存（紫外线会加速橡胶老化）；防潮防冻（温度不低于5°C）；避免接触化学品、油类和溶剂；水平放置并定期（每月）旋转1/4圈以防变形；使用专用支架支撑轴颈；不要将辊子直接放在地面上。不当保管会导致包胶永久变形、开裂或与辊体分离。", en: "Storage requirements for rubberised rolls: store away from light (UV accelerates rubber aging); protect from moisture and frost (min 5°C); avoid contact with chemicals, oils, and solvents; store horizontally and rotate 1/4 turn monthly to prevent deformation; support at journals with dedicated stands; never place directly on floor. Improper storage causes permanent cover deformation, cracking, or separation from roll body." }]},
                { title: "4.5 安装 Installation", paragraphs: [{ cn: "设备安装必须严格按照ANDRITZ提供的安装图纸和技术规范进行。安装步骤包括：基础检查（水平度、强度、地脚螺栓位置）；按安装顺序放置各部分；使用精密水平仪和激光对准仪进行对准；地脚螺栓灌浆；连接各模块间的管道、电气和气动接口。确保有足够的维护作业空间——这一点在规划车间布局时就必须考虑。", en: "Installation must strictly follow ANDRITZ assembly drawings and technical specifications. Steps include: foundation check (levelness, strength, anchor bolt positions); placement of sections in assembly sequence; alignment using precision levels and laser alignment tools; anchor bolt grouting; connecting piping, electrical, and pneumatic interfaces between modules. Ensure adequate maintenance space — this must be considered during workshop layout planning." }]},
                { title: "4.5.1 设备安装 Machine Installation", paragraphs: [{ cn: "设备主要模块的安装顺序：机架基础 → 干燥部（扬克缸）→ 压榨部 → 成型器 → 流浆箱 → 卷纸机。每个模块安装后需确认水平度和对准精度。所有紧固件须按规定的扭矩值拧紧（参见紧固件章节）。", en: "Main module installation sequence: frame foundation → dryer section (Yankee) → press section → former → headbox → reel. Verify levelness and alignment after each module installation. All fasteners must be tightened to specified torque values (see Fasteners section)." }]},
                { title: "4.5.2 外围设备 Peripheral Equipment", paragraphs: [{ cn: "外围设备包括：液压系统（管道连接、排气、压力测试）；气动系统（压缩空气管道、阀门、气缸）；润滑系统（中央润滑装置、管道、分配器）；真空系统（真空泵、管道、分离器）；蒸汽和冷凝水系统；供水系统（清水、白水循环）；电气和控制系统（MCC、DCS、仪表）。所有外围系统连接后须进行功能测试。", en: "Peripheral equipment includes: hydraulic system (pipe connections, bleeding, pressure test); pneumatic system (compressed air pipes, valves, cylinders); lubrication system (central unit, pipes, distributors); vacuum system (pumps, pipes, separators); steam and condensate system; water systems (fresh water, white water loop); electrical and control systems (MCC, DCS, instrumentation). Functional testing required after all connections." }]},
                { title: "4.6 连接 Connect Up", paragraphs: [{ cn: "连接所有公用设施接口：电力（按电气图纸连接MCC和现场设备）；压缩空气（检查压力和流量）；清水（按水质要求过滤）；蒸汽（保温处理、疏水阀安装）；真空管道（密封性检查）；排液管道（白水、废水、冷凝水）。所有连接必须进行密封性和功能测试。", en: "Connect all utility interfaces: electricity (per electrical drawings to MCC and field devices); compressed air (check pressure and flow); fresh water (filter per quality requirements); steam (insulate, install steam traps); vacuum piping (leak test); drainage (white water, waste water, condensate). All connections must undergo leak and function tests." }]},
                { title: "4.7 冷测试 Cold Test", paragraphs: [{ cn: "首次启动前必须进行冷测试（无浆料运行）。冷测试检查项目：所有驱动电机转动方向是否正确；所有辊子是否自由转动（无卡滞、无异响）；润滑系统是否向所有润滑点正常供油；液压和气动系统是否正常运作（无泄漏）；安全装置（急停、联锁、限位开关）功能是否正常；所有仪表显示是否正常；DCS控制系统信号是否正常；紧急停机是否立即停止所有驱动。冷测试中发现的问题必须在带浆料启动前全部解决。", en: "Cold test (running without stock) must be performed before initial start-up. Check items: all drive motor rotation directions correct; all rolls rotate freely (no binding, no abnormal noise); lubrication system supplies oil to all points; hydraulic and pneumatic systems functioning (no leaks); safety devices (E-STOP, interlocks, limit switches) function correctly; all instruments display normally; DCS control signals correct; E-STOP immediately stops all drives. All issues found during cold test must be resolved before starting with stock." }]},
                { title: "4.11 启动前提条件 Prerequisites for Start-up", paragraphs: [{ cn: "启动前必须满足：所有安装工作已完成并验收；冷测试已通过；所有安全装置已测试合格；操作人员已完成培训；所有润滑点已加注正确油脂；公用设施（水电气汽）可用且参数正常；DCS系统已配置完成；紧急预案和疏散路线已公布。", en: "Before start-up: all installation work completed and accepted; cold test passed; all safety devices tested and approved; operators trained; all lubrication points filled correctly; utilities (water, electricity, air, steam) available with normal parameters; DCS system configured; emergency plan and evacuation routes posted." }]},
                { title: "4.12 首次启动 Initial Start-up", paragraphs: [{ cn: "首次带浆料启动须与ANDRITZ启动工程师一起进行。启动过程中须密切监控所有参数（速度、温度、压力、真空度、定量、水分）。逐步提升速度至设计值，每次提速须确认运行稳定后再继续。记录所有运行参数作为日后参考基准。", en: "Initial start-up with stock must be performed together with ANDRITZ start-up engineers. Closely monitor all parameters (speed, temperature, pressure, vacuum, basis weight, moisture). Gradually increase speed to design value, confirming stable operation at each step before proceeding. Record all operating parameters as baseline reference." }]},
                { title: "4.8 拆卸与处置 Disassembly & Disposal", paragraphs: [{ cn: "设备使用寿命结束时须按环保要求处置。拆卸前排出所有流体（油、化学品、水）并分类处理。回收可再利用的材料（金属、塑料）。按当地法规处置危险废物（油品、化学品、电子部件）。", en: "Dispose of the machine per environmental requirements at end of service life. Drain all fluids (oil, chemicals, water) and treat separately before disassembly. Recycle reusable materials (metals, plastics). Dispose of hazardous waste (oils, chemicals, electronics) per local regulations." }]}
              ]
            },
            operation: {
    ...
    headbox: {
      ...
      data: {
        ...
        components: {
          ...
          componentDetails: {
            "stock-feed": { title: "进料/涂布器 Stock Feed/Spreader (1)", description: { cn: "将浆料均匀分配到流浆箱宽度方向。分配管道(1a)采用锥形截面，沿流动方向逐渐缩小以保证压力均匀。回流通过分配管道出口侧实现。伸缩接头(1b)安装在送料端用于容纳纵向膨胀。焊接钢制结构，内部抛光。", en: "Distributes stock evenly across headbox width. Distribution pipes (1a) have tapered (conical) cross-section narrowing in flow direction for uniform pressure. Return flow at outlet side. Expansion joints (1b) on feed side for length compensation. Welded steel, internally polished." }, image: "images-headbox/page13-img02.jpeg", imageCaption: "Fig. 3: Distributor with supporting structure / 分配器+支撑结构" },
            "pivoting-device": { title: "摆动装置 Pivoting Device (2)", description: { cn: "用于将流浆箱摆动到不同工作位置。除工作位置外还有：网更换位置和辊更换/清洁位置。摆动装置(2a)用于手动摆动流浆箱。运行中可调节。详见维护章节。", en: "Swings headbox into different positions. Besides operating position: wire changing position and roll changing/cleaning position. Pivoting device (2a) for manual swinging. Adjustable during operation. See Maintenance section." }, image: "images-headbox/page14-img02.jpeg", imageCaption: "Fig. 4: Pivoting device / 摆动装置" },
            "locking-device": { title: "锁定装置 Locking Device (3)", description: { cn: "在维护工作中锁定流浆箱位置，确保安全。流浆箱摆动到任何非工作位置后，必须使用锁定装置将其固定，防止意外移动导致人员受伤或设备损坏。", en: "Locks headbox position during maintenance for safety. After swinging to any non-operating position, the headbox must be secured with the locking device to prevent unexpected movement causing injury or equipment damage." }, image: "images-headbox/page16-img02.jpeg", imageCaption: "Fig. 5: Locking device / 锁定装置" },
            "micro-adjusters": { title: "微调装置 Micro-adjusters (4)", description: { cn: "用于精确调节唇口开度。每个微调器通过主轴独立控制唇口的局部开度。调节范围及限制：相邻主轴间最大差0.25 mm，全宽最大差0.5 mm。出厂时已由ANDRITZ技术人员预设，不建议未经培训的人员自行调整。", en: "For precise lip opening adjustment. Each micro-adjuster independently controls local lip opening via spindle. Limits: max 0.25 mm spindle-to-spindle, 0.5 mm across full width. Factory preset by ANDRITZ technicians; not recommended for untrained personnel." }, image: "images-headbox/page16-img03.jpeg", imageCaption: "Fig. 6: Micro-adjusters / 微调装置" },
            "diffuser-block": { title: "阶梯扩散器 Step Diffuser Block (5)", description: { cn: "通过阶梯结构使纤维悬浮液均匀分布，防止絮聚。扩散器块的阶梯形截面使浆流产生湍流，确保纤维在宽度方向上均匀分布。这是实现良好纸张成形的关键部件。", en: "Uniformly distributes fiber suspension through step structure preventing flocculation. The stepped cross-section creates turbulence ensuring uniform fiber distribution across the width. Key component for good sheet formation." }, function: { cn: "保证压力、体积分布均匀，避免纤维絮聚和沉淀。", en: "Ensures uniform pressure and volume distribution, preventing fiber flocculation and sedimentation." }, image: "images-headbox/page17-img02.jpeg", imageCaption: "Fig. 7: Step diffuser block - Outlet side / 阶梯扩散器出口侧" },
            "indicating-device": { title: "指示装置 Indicating Device (6)", description: { cn: "显示唇口开度的刻度装置。位于流浆箱操作侧，指示当前浆片唇口的开度值。操作人员可据此监控和记录唇口设定。配合间隙测量(7)使用。", en: "Scale device showing slice lip opening. Located on operator side, indicates current slice lip opening value. Operators monitor and record lip settings. Used together with gap measuring (7)." }, image: "images-headbox/page19-img02.jpeg", imageCaption: "Fig. 9: Headbox gap scale / 流浆箱间隙刻度" },
            "gap-measuring": { title: "间隙测量 Gap Measuring (7)", description: { cn: "测量浆片唇口与成形辊之间的间隙。精确的间隙测量对纸张成形质量至关重要。间隙过大导致喷射速度不足，过小则可能损坏唇口或成形辊。", en: "Measures gap between slice lip and forming roll. Precise gap measurement crucial for formation quality. Too large gap reduces jet velocity; too small may damage lip or forming roll." }, image: "images-headbox/page20-img02.jpeg", imageCaption: "Fig. 10: Gap measuring / 间隙测量" },
            ...
            "nozzle-chamber": { title: "喷嘴腔 Nozzle Chamber (9)", description: { cn: "浆料在此加速并通过唇口喷出。喷嘴腔的几何形状决定了喷射速度和角度，直接影响纸张成形的质量。喷嘴腔内部抛光以减少流体阻力。浆片和裙缘唇口位于喷嘴腔出口处。", en: "Stock accelerates here and jets through slice lip. Nozzle chamber geometry determines jet velocity and angle, directly affecting sheet formation quality. Interior is polished to reduce flow resistance. Slice and apron lips are located at the nozzle chamber outlet." }, image: "images-headbox/page21-img02.jpeg", imageCaption: "Fig. 12: Nozzle chamber / 喷嘴腔" },
            "slice-lips": { title: "浆片和裙缘 Slice & Apron Lips (11, 12)", description: { cn: "浆片唇口（上唇）和裙缘唇口（下唇）共同构成喷嘴出口。浆片唇口的开度和形状决定纸张成形质量和横幅定量分布。出厂时已由ANDRITZ技术人员设定并锁定。调节方法见维护章节「设定浆片唇口」。相邻主轴间最大差0.25 mm，全宽最大差0.5 mm。", en: "Slice lip (upper) and apron lip (lower) form the nozzle outlet. Slice lip opening and shape determine formation quality and cross-direction basis weight profile. Factory set and locked by ANDRITZ technicians. See 'Setting Slice Lip' in Maintenance. Max diff: 0.25 mm spindle-to-spindle, 0.5 mm full width." }},
            "suction-pipe": { title: "抽吸装置 Suction Pipe (15)", description: { cn: "用于清理喷淋器的抽吸装置。在清洁过程中使用该装置吸除喷嘴腔和管束区域的残留物和清洁液。确保清洁后无残留物影响纸张质量。", en: "Suction device for cleaning showers. Used during cleaning to remove residues and cleaning fluid from nozzle chamber and tube bank areas. Ensures no residues remain to affect paper quality." }, image: "images-headbox/page23-img02.jpeg", imageCaption: "Fig. 13: Suction pipe / 抽吸装置" }
          }
        },
        maintenance: {
          topics: {
            ...
            "swinging-headbox": { icon: "🔄", title: "摆动流浆箱 Swinging (4.9)", subtitle: "4个工作位置切换操作", alerts: [{ type: "danger", title: "⚠️ 夹持与挤压危险", content: "流浆箱摆动时有挤压和夹持危险！必须使用锁定装置固定每个非工作位置！控制面板钥匙必须从OPERATION切换到SERVICE！所有人员在摆动操作前必须离开危险区域！<br><small>Crushing and shearing danger during swinging! Locking device must secure every non-operating position! Control panel key must switch from OPERATION to SERVICE! All personnel must leave danger zone before swinging!</small>" }], sections: [
    ...
    former: {
      ...
      data: {
        ...
        maintenance: {
          ...
          procedures: {
            "change-wire": { icon: "🕸️", title: "更换网 Wire Change (4.11.1)", alerts: [{ type: "danger", title: "⚠️ 重物吊装", content: "穿戴个人防护装备。不要在悬吊载荷下行走！操作侧机架打开时确保支撑牢固。更换网期间设备必须完全停机并锁定。<br><small>Wear PPE. Do not walk under suspended loads! Ensure cantilever is securely supported when open. Machine must be completely shut down and locked during wire change.</small>" }], sections: [
            ...
            "change-felt": { icon: "🧶", title: "更换毛毯 Felt Change (4.11.2)", alerts: [{ type: "danger", title: "⚠️ 重物吊装", content: "注意夹持点。穿戴防护装备。更换毛毯期间设备必须完全停机并锁定。毛毯张力释放后才能进行操作。<br><small>Watch for pinch points. Wear PPE. Machine must be shut down and locked. Release felt tension before proceeding.</small>" }], steps: [{ label: "1", cn: "释放毛毯张力。打开悬臂机架。", en: "Relieve felt tension. Open cantilever frame." }, { label: "2", cn: "拆除旧毛毯。穿入新毛毯。关闭机架，张紧。", en: "Remove old felt. Thread new felt. Close frame, tension." }]},
            ...
            "roll-forming": { title: "更换成形辊 Forming Roll 2.1 (Ø1500mm, 7500kg)", alerts: [{ type: "danger", title: "⚠️ 重物危险", content: "成形辊重7500kg！必须使用额定载荷足够的起重机。所有吊具使用前必须检查。辊子移出时轨道必须正确安装并固定。<br><small>Forming roll weighs 7500kg! Use adequately rated crane. Inspect all rigging before use. Rails must be correctly installed and secured before roll removal.</small>" }], image: "images-former/page68-img01.png", imageCaption: "Fig. 15-18: Changing forming roll / 更换成形辊", steps: [{ label: "1", cn: "安装滑动管到悬臂上。安装移出轨道。", en: "Mount slip-on tubes, run-out rails." }, { label: "2", cn: "用起重机固定成形辊。拆卸轴承座螺栓。", en: "Secure roll with crane. Detach bearing bolts." }, { label: "3", cn: "沿轨道移出。按相反顺序安装。", en: "Run out on rails. Install reverse order." }]},
            ...
            "change-bearings": { icon: "🔩", title: "更换轴承 Bearing Change (4.13)", alerts: [{ type: "danger", title: "⚠️ 安全警告", content: "轴承更换需要专用液压工具（液压螺母和手动泵）。使用前检查液压设备是否完好。高压油可能导致严重伤害。按正确步骤操作以避免轴承或轴颈损坏。<br><small>Bearing change requires specialized hydraulic tools (hydraulic nut and hand pump). Inspect hydraulic equipment before use. High-pressure oil can cause serious injury. Follow correct procedure to avoid bearing or journal damage.</small>" }], sections: [
